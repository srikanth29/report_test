...
$nextTokentopup='';
$topfile = fopen( '/var/www/html/statistics/test1.json', 'w' );
fclose($topfile);
$topfile = fopen("/var/www/html/statistics/test1.json", "a+") or die("Unable to open file!");
...
foreach(file('/var/www/html/statistics/test1.json') as $line) 
{
