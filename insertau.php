...
$loggroup='AU-Platform-OldCode-Log';
...
$nextTokentopup='';
$topfile = fopen( '/var/www/html/statistics/au_out.json', 'w' );
fclose($topfile);
$topfile = fopen("/var/www/html/statistics/au_out.json", "a+") or die("Unable to open file!");
...
foreach(file('/var/www/html/statistics/au_out.json') as $line) 
{
...
$sql = "INSERT INTO `log_au`(`Time_stamp`,`API`,`Error_code`,`Error_desc`,`Transaction_id`) VALUES ('$time','$api', '$error_c', '$error_d', '$transaction')";
