...
#echo $api_name_error[$m];
	...
	#echo "dddd";
            ...
            $query_api_error = "SELECT Error_desc,COUNT(*) as freq FROM `$table_log` WHERE API='$aaaa' && Error_code!='0' && Time_stamp BETWEEN '$from' AND '$to' GROUP BY Error_desc ASC ORDER BY `freq` DESC " ; 
